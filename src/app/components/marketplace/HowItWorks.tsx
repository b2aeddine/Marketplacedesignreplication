...
import imgWoman1 from "figma:asset/3f18a1bcb3010a7cb832c06c549b570cad163eb1.png";
...
import imgHands3 from "figma:asset/f9775a8a04adfbb6d9f112f67f6d0d93c731f708.png";
import imgLike111 from "figma:asset/02a650a1a1ca32c4ad6e82400109d4d30e0ebc47.png";
import imgImage from "figma:asset/c4e1c40e7c8803235b3fb411339615a2cd0704eb.png";
import imgRemoveBg1 from "figma:asset/07b35ab1de6cca52d52120a93c6191bf7086177d.png";
import imgImage1 from "figma:asset/8560c92425087dc2482892462124a91a6e2561a3.png";
import imgRemoveBg3 from "figma:asset/eb549fcf1ece6a1956966c10b8e089c5ab16408f.png";
import imgImage2 from "figma:asset/e756a21ccab6e1b57f3af24b667128d58da9d275.png";
      ...
      <div className="relative shrink-0 w-full" data-name="How we Work Section - 3">
        <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[64px] items-center px-[245px] py-[64px] relative w-full">
            ...
            />
            <StepReverse
              title={<>2# Monetiser votre audience<span style={{ fontVariationSettings: "'opsz' 14" }}>:</span></>}
              desc="Based on the brief and research, the agency's creative team generates ideas for the campaign. These concepts are presented to the client for feedback and refinement."
              illustration={<Illustration1 />}
            />
            <Step
              title={<><span>{`3# Vendre des services? `}</span><span style={{ fontVariationSettings: "'opsz' 14" }}>:</span></>}
              desc="Once the concept is approved, the agency's designers and developers bring it to life. This includes creating visual assets, writing copy, and developing multimedia content."
